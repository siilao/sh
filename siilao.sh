...
if grep -q '^ENABLE_STATS="false"' /usr/local/bin/s > /dev/null 2>&1; then
	sed -i 's/^ENABLE_STATS="true"/ENABLE_STATS="false"/' ./siilao.sh
...
if [ "$country" = "CN" ]; then
  cd ~
  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/docker/install && chmod +x install
...
install_add_docker() {
	...
	if  [ -f /etc/os-release ] && grep -q "Fedora" /etc/os-release; then
		...
		s install docker docker-compose
		install_add_docker_cn
		s enable docker
		s start docker
	fi
...
install_ldnmp_conf() {
  ...
  wget -O /home/web/docker-compose.yml ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/docker/LNMP-docker-compose-10.yml
...
install_certbot() {
  ...
  # 下载并使脚本可执行
  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/auto_cert_renewal.sh
...
cluster_python3() {
  cd ~/cluster/
  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/siilao/python-for-vps/main/cluster/$py_task
...
f2b_install_sshd() {
  ...
  if grep -q 'Alpine' /etc/issue; then
    ...
    curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/config/fail2ban/alpine-sshd.conf
    curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/config/fail2ban/alpine-sshd-ddos.conf
    cd /path/to/fail2ban/config/fail2ban/jail.d/
      curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/config/fail2ban/alpine-ssh.conf
  elif command -v dnf &>/dev/null; then
    cd /path/to/fail2ban/config/fail2ban/jail.d/
    curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/config/fail2ban/centos-ssh.conf
  else
    install rsyslog
    systemctl start rsyslog
    systemctl enable rsyslog
    cd /path/to/fail2ban/config/fail2ban/jail.d/
    curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/config/fail2ban/linux-ssh.conf
  fi
}
...
bbrv3() {
		  ...
		  if dpkg -l | grep -q 'linux-xanmod'; then
            ...
            wget -qO - ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/archive.key | gpg --dearmor -o /usr/share/keyrings/xanmod-archive-keyring.gpg --yes

						# 步骤3：添加存储库
						echo 'deb [signed-by=/usr/share/keyrings/xanmod-archive-keyring.gpg] http://deb.xanmod.org releases main' | tee /etc/apt/sources.list.d/xanmod-release.list

            # version=$(wget -q https://dl.xanmod.org/check_x86-64_psabi.sh && chmod +x check_x86-64_psabi.sh && ./check_x86-64_psabi.sh | grep -oP 'x86-64-v\K\d+|x86-64-v\d+')
            version=$(wget -q ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/check_x86-64_psabi.sh && chmod +x check_x86-64_psabi.sh && ./check_x86-64_psabi.sh | grep -oP 'x86-64-v\K\d+|x86-64-v\d+')
...
linux_tools() {
  ...
  while true; do
	  ...
	  echo -e "${gl_slao}13.  ${gl_bai}ncdu 磁盘占用查看工具             ${gl_slao}14.  ${gl_bai}fzf 全局搜索工具"
...
linux_Oracle() {
	 ...
	 while true; do
	  ...
	  echo -e "${gl_slao}6.   ${gl_bai}IPV6恢复工具"
	  echo -e "${gl_slao}------------------------"
	  echo -e "${gl_slao}0.   ${gl_bai}返回主菜单"
	  echo -e "${gl_slao}------------------------${gl_bai}"
	  read -e -p "请输入你的选择: " sub_choice
...
linux_ldnmp() {
  ...
  while true; do
    ...
    wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/nginx/discuz.com.conf
    ...
    mkdir $yuming
    cd $yuming
    wget -O latest.zip ${gh_proxy}https://github.com/siilao/sh/blob/main/file/Discuz_X3.5_SC_UTF8_20240520.zip
    unzip latest.zip
    rm latest.zip
    ...
    wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/nginx/kdy.com.conf
    sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
    ...
    wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/nginx/maccms.com.conf
    ...
    cd /home/web/html/$yuming/template/ && wget ${gh_proxy}https://github.com/siilao/sh/blob/main/file/DYXS2.zip && unzip DYXS2.zip && rm /home/web/html/$yuming/template/DYXS2.zip
    cp /home/web/html/$yuming/template/DYXS2/asset/admin/Dyxs2.php /home/web/html/$yuming/application/admin/controller
    cp /home/web/html/$yuming/template/DYXS2/asset/admin/dycms.html /home/web/html/$yuming/application/admin/view/system
    mv /home/web/html/$yuming/admin.php /home/web/html/$yuming/vip.php && wget -O /home/web/html/$yuming/application/extra/maccms.php https://github.com/siilao/sh/blob/main/file/maccms.php
    ...
    wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/nginx/dujiaoka.com.conf
    ...
    wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/nginx/flarum.com.conf
    sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/nginx/typecho.com.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
    ...
    wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/nginx/index_php.conf
    sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
    ...
    wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/nginx/rewrite.conf
    sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
    sed -i "s/baidu.com/$reverseproxy/g" /home/web/conf.d/$yuming.conf
	  ...
	  wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/nginx/reverse-proxy-domain.conf
	  sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
    ...
    wget -O /home/web/conf.d/$yuming.conf ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/nginx/html.conf
    sed -i "s/yuming.com/$yuming/g" /home/web/conf.d/$yuming.conf
    ...
    cd ~
    wget -O ${useip}_beifen.sh ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/beifen.sh > /dev/null 2>&1
		...
		if docker inspect fail2ban &>/dev/null ; then
			  ...
			  case $sub_choice in
				  ...
				  21)
					  ...
					  wget -O /home/web/conf.d/default.conf ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/nginx/default11.conf
					  docker restart nginx
            ...
            curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/config/fail2ban/cloudflare-docker.conf
            ...
            install jq bc
            check_crontab_installed
            curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/CF-Under-Attack.sh
	...
	36)
		  while true; do
			  ...
			  case $sub_choice in
				  ...
				  # php调优
				  wget -O /home/optimized_php.ini ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/optimized_php.ini
				  docker cp /home/optimized_php.ini php:/usr/local/etc/php/conf.d/optimized_php.ini
				  docker cp /home/optimized_php.ini php74:/usr/local/etc/php/conf.d/optimized_php.ini
				  rm -rf /home/optimized_php.ini

				  # php调优
				  wget -O /home/www.conf ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/www-1.conf
				  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
				  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
				  rm -rf /home/www.conf

				  # mysql调优
				  wget -O /home/custom_mysql_config.cnf ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/custom_mysql_config-1.cnf
				  ...
				  # php调优
				  wget -O /home/www.conf ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/www.conf
				  docker cp /home/www.conf php:/usr/local/etc/php-fpm.d/www.conf
				  docker cp /home/www.conf php74:/usr/local/etc/php-fpm.d/www.conf
				  rm -rf /home/www.conf

				  # mysql调优
				  wget -O /home/custom_mysql_config.cnf ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/custom_mysql_config.cnf
				  docker cp /home/custom_mysql_config.cnf mysql:/etc/mysql/conf.d/
				  rm -rf /home/custom_mysql_config.cnf
			...
			while true; do
				...
				case $choice in
					1)
						...
						curl -o /home/docker/cloud/docker-compose.yml ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/docker/cloudreve-docker-compose.yml
	  ...
	  case $sub_choice in
		  1)
			  while true; do
				  ...
				  echo "alias $kuaijiejian='s'" >> ~/.bashrc
				  sleep 1
				  source ~/.bashrc
...
EOF
		  ...
		  21)
			  ...
			  while true; do
				  ...
				  case $host_dns in
					  1)
						  read -e -p "请输入新的解析记录 格式: 110.25.5.33 siilao.pro : " addhost
			...
			while true; do
				...
				case "$Limiting" in
				  1)
					...
					cd ~
					curl -Ss -o ~/Limiting_Shut_down.sh ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/Limiting_Shut_down1.sh
			  ...
			  case "$choice" in
				[Yy])
				  ...
				  if [ -f ~/TG-check-notify.sh ]; then
					  ...
					  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/TG-check-notify.sh
					  chmod +x ~/TG-check-notify.sh
					  nano ~/TG-check-notify.sh
				  fi
				  ...
				  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/TG-SSH-check-notify.sh > /dev/null 2>&1
		  ...
		  26)
			  ...
			  cd ~
			  curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/upgrade_openssh9.8p1.sh
		  ...
		  100)
			...
			while true; do
			  ...
			  case $sub_choice in
				  1)
					  cd ~
					  sed -i 's/^ENABLE_STATS="false"/ENABLE_STATS="true"/' /usr/local/bin/s
					  sed -i 's/^ENABLE_STATS="false"/ENABLE_STATS="true"/' ./siilao.sh
					  echo "已开启采集"
      ...
      101)
          clear
          send_stats "卸载siilao一键脚本"
          echo "卸载siilao一键脚本"
          echo "------------------------------------------------"
          echo "将彻底卸载siilao脚本，不影响你其他功能"
...
EOF
		  ...
		  2)
			  ...
			  while true; do
				  ...
				  echo "------------------------"
				  echo "11. 安装siilao一键脚本         12. 更新系统              13. 清理系统"
...
siilao_update() {
	...
	echo "更新日志"
	echo "------------------------"
	echo "全部日志: ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/siilao_sh_log.txt"
	echo "------------------------"

  curl -s ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/siilao_sh_log.txt | tail -n 35
  sh_v_new=$(curl -s ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/siilao.sh | grep -o 'sh_v="[0-9.]*"' | cut -d '"' -f 2)
	...
	if [ "$sh_v" = "$sh_v_new" ]; then
		...
		case "$choice" in
			[Yy])
				...
				country=$(curl -s ipinfo.io/country)
				if [ "$country" = "CN" ]; then
          curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/cn/siilao.sh && chmod +x siilao.sh
				else
          curl -sS -O ${gh_proxy}https://raw.githubusercontent.com/siilao/sh/main/siilao.sh && chmod +x siilao.sh
				fi
				CheckFirstRun_true
				yinsiyuanquan2
        cp -f ./siilao.sh /usr/local/bin/s > /dev/null 2>&1
...
echo "软件状态查看        s status sshd | s 状态 sshd "
